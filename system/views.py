...
def display_schedule(request):
    table_options = {
        'table_header': ['Team 1', 'Team 2', 'Location', 'Date'],
        # Note these are examples of a generic schedule until they are stored in the database
        'table_rows': [
            ['Barcelona', 'Elite FC', 'Madina Al Riyadiya, Lebanon', 'Monday April 4, 2022'],
            ['Kappa', 'Knee-Z', 'Paris, France', 'Wednesday June 8, 2022'],
            ['UK', 'United States', 'United Kingdom', 'Friday July 17, 2022']
        ]
    }
